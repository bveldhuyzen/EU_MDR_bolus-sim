...
All devices discussed in this repository are subject to strict regulations.[4][5] Manufacturers must perform extensive testing procedures before a release on the market is allowed.[6][7] Yet, miscalculations of the bolus calculator are not unheard of.[8][9] Miscalculation of a bolus by the bolus calculator may cause the user to administer an incorrect (suboptimal) dose of insulin, according to the treatment and device specifications. This may cause harm and even death of the patient.[10][11] Adequate documentation of the specifications of bolus calculators in the instructions for use is therefore of great importance for validation purposes.[*] Users and healthcare providers, and preferably also their circles, must be able to confirm if the device works as intended, at all times.[12]
